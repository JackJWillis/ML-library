...
NAME <- "ghana_pe"
gh_pe <- load_dataset(NAME)
```

## Data

This is a sample analysis of the ghana dataset from 2006, using variables which are pre feature extraction (as far as possible).
The dataset has `r nrow(gh_pe)` rows and `r ncol(gh_pe)` columns.
